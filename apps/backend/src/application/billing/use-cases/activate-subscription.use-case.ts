...
import { ActivateSubscriptionDto, SubscriptionDto } from '../dto';
import type { ISubscriptionRepository } from '../../../domain/billing/repositories';

/**
 * Use Case: Activate a subscription
 *
 * This use case orchestrates activating a trial or cancelled subscription:
 ...
 */
@Injectable()
export class ActivateSubscriptionUseCase implements IUseCase<
...
> {
  ...
  async execute(request: ActivateSubscriptionDto): Promise<SubscriptionDto> {
    ...
    try {
      ...
      throw new BusinessRuleViolationError(
        error instanceof Error ? error.message : 'Cannot activate subscription',
