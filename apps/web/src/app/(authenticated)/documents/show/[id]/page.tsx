        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
            ...
            <p className="text-gray-600 mb-6">
              This action cannot be undone. The document &quot;{document.title}&quot; will be
              permanently deleted.
            </p>
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="flex gap-3 items-center">
              ...
              <span className="text-gray-600">{translate(`documents.types.${document.type}`)}</span>
            </div>
          </div>
          {/* Action Buttons */}
      ...
      <div className="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 border-b pb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-900">{new Date(document.updatedAt).toLocaleString()}</p>
          </div>
        </div>
